...
安卓中的动画分为两大类，三种动画：**视图动画以及属性动画**两大类，补间动画&逐帧动画
 ...
 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6fd0ca5a9a.png)
...
##### 逐帧动画/图像动画(Drawable Animation)
 ...
 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6fd0e98f5a.png) 
...
##### 补间动画/视图动画(View  Animation)
 ...
 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6fd0d50fc3.png) 

- 分类 根据不同的动画效果，补间动画分为4种动画，具体如下图

  通过指 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6fd104d082.png) 
...
###### 提出原因
 ...
 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6fd11a9ba8.png) 
...
###### 简介
 ...
 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6fea11da8f.png) 

具体使用：

  属性动画的使用类主要是：`ValueAnimator` 类 & `ObjectAnimator` 类，具体介绍如下 

 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6fef0031b0.png) 
...
![yvb6133s76](动画机制.assets/16323c6ff12dbc73.png)
...
AnimatedVectorDrawable通过ObjectAnimator属性动画控制VectorDrawable，利用矢量图形的特性，从而达成各种炫酷的动画效果。
 ...
 ![img](动画机制.assets/3910623-acc5a19e1f59828e.png)
...
![img](动画机制.assets/163b0b8ca7992c73.png)

标签一览

![img](动画机制.assets/163b0b8ca79492ed.png)
...
![img](动画机制.assets/163b0b8ca78a8e24.png)
...
##### 简介：
 ...
 ![img](动画机制.assets/ahu0u0rfd4.png) 

 ![《Android必读之Android 动画种类详解》](动画机制.assets/16323c6ff4452ea6.png) 
...
![img](动画机制.assets/7nnzi8bx2n.png)

![img](动画机制.assets/n4mhh84aee.png)
...
![img](动画机制.assets/yvb6133s76.png)
...
要了解 Android 动画是如何画出来的，我们首先要了解 Android 的 View 是如何组织在一起，以及他们是如何画自己的内容的。每一个窗口就是一棵 View 树，下面以我们写的 android_tabwidget_tutorial.doc 中的 tab 控件的窗口为例，通过 android 工具 hierarchyviewer 得到的窗口 View Tree 如下图 1 所示：
 ![界面 View 结构图](动画机制.assets/1.png) 

 ![界面 View 结构和显示对应图图](动画机制.assets/2.jpg) 
...
[动画](https://juejin.im/post/5b0e8554f265da08ed7a15d1)

[转场](https://juejin.im/post/5b0e8554f265da08ed7a15d1)
